...
RSpec.describe 'User show', type: :feature do
  before(:each) do
    ...
    @second_post = Post.create(author: @first_user, title: 'Hola', text: 'This is my second post', comments_counter: 0, likes_counter: 0)
    @third_post = Post.create(author: @first_user, title: 'Honjour', text: 'This is my third post', comments_counter: 0, likes_counter: 0)
    @fourth_post = Post.create(author: @first_user, title: 'Salam', text: 'This is my fourth post', comments_counter: 0, likes_counter: 0)
